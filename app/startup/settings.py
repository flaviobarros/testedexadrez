...
# Flask-Mail settings
MAIL_USERNAME =           os.getenv('MAIL_USERNAME',        'testedexadrez@gmail.com')
MAIL_PASSWORD =           os.getenv('MAIL_PASSWORD',        'aGwVmbSihGIYowcpDrGl0A')
MAIL_DEFAULT_SENDER =     os.getenv('MAIL_DEFAULT_SENDER',  'TESTE DE XADREZ' + ' <testedexadrez@gmail.com>')
...
ADMINS = []
admin1 = os.getenv('ADMIN1', '"Admin One" <flaviomargarito@gmail.com>')
